...
import { BlogPostInterviewTips } from "@/constant";
        ...
        <div className="max-w-7xl">
          ...
          <div className="mt-20">
            <h4 className={` text-black/50 ${poppins.className}`}>
              <em>
                Interviews are one of the most critical stages in the hiring
                process, and thorough preparation can significantly increase
                your chances of success. Whether you&apos;re interviewing for
                your dream job or exploring new career opportunities, making a
                strong impression on potential employers is crucial. Here are
                essential interview preparation tips to help you excel and stand
                out from the competition.
              </em>
            </h4>
          </div>
          <div>
            {BlogPostInterviewTips.map((post, i) => (
              <div key={i}>
          ...
          <p className="text-black text-xs mt-4">#InterviewTips</p>
        </div>
      </section>
    </>
  );
